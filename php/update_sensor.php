<?php
// Require the database.php file, which contains the Database class used to connect to the database.
...
if (!empty($_POST)) {
    ...
    while ($found_empty == false) {
        // Generate a random string of characters and numbers, with a length of 10 characters.
