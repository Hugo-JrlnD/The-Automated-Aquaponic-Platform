    ...
    <table class="styled-table" id= "table_id">
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          $num = 0;
          //------------------------------------------------------------ The process for displaying a record table containing the water level sensor data
          $pdo = Database::connect();
          $sql = 'SELECT * FROM water_level_temp ORDER BY date, time';
          foreach ($pdo->query($sql) as $row) {
            ...
            echo '<td class="bdr">'. $row['Status_WLS'] . '</td>';
