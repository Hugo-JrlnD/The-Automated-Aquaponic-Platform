...
String postData = ""; // Variable sent for HTTP POST request data
...
#define sensorPin 35
int water_level;
String Status_WLS = ""; // If the sensor is working and receives values
...
void loop()
{
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    get_WLS_data();  // Calls the get_DHT11_sensor_data() subroutine
